...
//    public static WebEventListener eventListener;
    ...
    public TestBase() throws FileNotFoundException {
        ...
        try {
            ...
            prop = new Properties();
            FileInputStream ip = new FileInputStream("C:/Users/Rahul/IdeaProjects/Jenkins_Facebook/src/main/java/com/facebook/qa/config/Config.properties");
            prop.load(ip);
        } catch (IOException e) {
    ...
    public static void initialization() throws FileNotFoundException {
        ...
        if (browserName.equals("chrome")) {
            ...
            System.setProperty("webdriver.gecko.driver", "C:/Users/Rahul/OneDrive/Desktop/selenium/chromedriver/geckodriver.exe");
